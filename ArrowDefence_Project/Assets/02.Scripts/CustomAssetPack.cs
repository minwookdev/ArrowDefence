namespace ActionCat
{
    ...
    public static class CustomAssetPack
    {
        ...
        { // 에셋 팩 구성 함수
            SoundAssetPackName = "sound_assetpack_107";
            FontsAssetPackName = "fonts_assetpack_107";
            SoundAssetFolderPath = "Assets/10.Sounds/packing_sound";
            FontsAssetFolderPath = "Assets/04.Fonts/packing_fonts";
            ...
            //assetPackConfig.DefaultTextureCompressionFormat = TextureCompressionFormat.Etc2; // Texture Asset Pack의 경우의 압축포맷 지정
