namespace CodingCat_Games
{
    ...
    public class ItemData_Equip_Bow : ItemData_Equip
    {
        ...
        public Enum_BowSkillType FirstSkill_Type;
        public Enum_BowSkillType SecondSkill_Type;
        ...
        private void SetBowSkills()
        {
            ...
            {
                case Enum_BowSkillType.SKILL_NULL:        BowSkill_First = null;                      break;
                case Enum_BowSkillType.SKILL_SPREAD_SHOT: BowSkill_First = new Skill_Multiple_Shot(); break;
                case Enum_BowSkillType.SKILL_RAPID_SHOT:  BowSkill_First = new Skill_Rapid_Shot();    break;
                case Enum_BowSkillType.SKILL_ARROW_RAIN:  BowSkill_First = new Skill_Arrow_Rain();    break;
                default: break;
            }

            switch (SecondSkill_Type)
            {
                case Enum_BowSkillType.SKILL_NULL:        BowSkill_Second = null;                      break;
                case Enum_BowSkillType.SKILL_SPREAD_SHOT: BowSkill_Second = new Skill_Multiple_Shot(); break;
                case Enum_BowSkillType.SKILL_RAPID_SHOT:  BowSkill_Second = new Skill_Rapid_Shot();    break;
                case Enum_BowSkillType.SKILL_ARROW_RAIN:  BowSkill_Second = new Skill_Arrow_Rain();    break;
                default: break;
            }
